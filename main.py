...
def attack(char_name: str, char_class: str) -> str:
    """Функция attack (char_name, char_class) -> str."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция defence (char_name, char_class) -> str. """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция special (char_name, char_class) -> str. Применение
    специальных умений.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция start_training (char_name, char_class) -> str. Выбор игрока"""
    if char_class == 'warrior':
...
def main():
    """Функция main -> str. Запускается в самом начале игры"""
